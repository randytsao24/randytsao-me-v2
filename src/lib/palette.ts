...
export const NOCTURNE_PALETTE: Palette = {
  ...
  sunGlowInner: "rgba(223,232,232,0.28)",
  sunGlowMid: "rgba(218,228,228,0.20)",
  sunGlowOuter: "rgba(210,222,222,0.10)",
  sunGlowFar: "rgba(200,215,215,0.05)",
  sunGlowEdge: "rgba(190,205,205,0)",
  sunEllipseFill: "rgba(223,232,232,0.30)",
  sunEllipseShadow: "rgba(210,220,220,0.30)",
  sunXFrac: 0.65,
  sunYOffset: 55,
  sunRadiusX: 30,
  sunRadiusY: 25,
